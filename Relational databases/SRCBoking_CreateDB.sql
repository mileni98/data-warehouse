drop table "SSP_RES".SRC_Country cascade constraints;
drop table "SSP_RES".SRC_City cascade constraints;
drop table "SSP_RES".SRC_Guest cascade constraints;
drop table "SSP_RES".SRC_Building cascade constraints;
drop table "SSP_RES".SRC_Apartment_Type cascade constraints;
drop table "SSP_RES".SRC_Apartment cascade constraints;
drop table "SSP_RES".SRC_Reservation cascade constraints;
drop table "SSP_RES".SRC_Content cascade constraints;
drop table "SSP_RES".SRC_Contains cascade constraints;
drop table "SSP_RES".SRC_Apartment_Ocupancy cascade constraints;
drop table "SSP_RES".SRC_Pricelist cascade constraints;


/*==============================================================*/
/* Table: SRC_Country                                           */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Country (
...
/* Table: SRC_Guest                                             */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Guest (
...
/* Table: SRC_Building                                          */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Building (
...
ALTER TABLE "SSP_RES".SRC_Building 
...
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Apartment_Type (
...
ALTER TABLE "SSP_RES".SRC_Apartment 
...
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Reservation (
...
ALTER TABLE "SSP_RES".SRC_Reservation 
...
/* Table: SRC_Content 	            	                        */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Content (
...
/* Table: SRC_Contains 	            	                        */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Contains (
    content_id    		INTEGER 		NOT NULL,
    apartment_id  		INTEGER 		NOT NULL,
...
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Apartment_Ocupancy (
...
/* Table: SRC_Pricelist 	                                */
/*==============================================================*/
CREATE TABLE "SSP_RES".SRC_Pricelist (
...
ALTER TABLE "SSP_RES".SRC_Apartment 
    ADD CONSTRAINT fk_apart_apart_type FOREIGN KEY ( apartment_type_id )
        REFERENCES "SSP_RES".SRC_Apartment_Type ( apartment_type_id );

ALTER TABLE "SSP_RES".SRC_Apartment 
    ADD CONSTRAINT fk_apartment_building FOREIGN KEY ( building_id )
        REFERENCES "SSP_RES".SRC_Building ( building_id );

ALTER TABLE "SSP_RES".SRC_Building 
    ADD CONSTRAINT fk_building_city FOREIGN KEY ( city_id )
        REFERENCES "SSP_RES".SRC_City ( city_id );

ALTER TABLE "SSP_RES".SRC_City 
    ADD CONSTRAINT fk_city_country FOREIGN KEY ( country_id )
        REFERENCES "SSP_RES".SRC_Country ( country_id );

ALTER TABLE "SSP_RES".SRC_Contains 
    ADD CONSTRAINT fk_contains_apart FOREIGN KEY ( apartment_id )
        REFERENCES "SSP_RES".SRC_Apartment ( apartment_id );

ALTER TABLE "SSP_RES".SRC_Contains 
    ADD CONSTRAINT fk_contains_content FOREIGN KEY ( content_id )
        REFERENCES "SSP_RES".SRC_Content ( content_id );

ALTER TABLE "SSP_RES".SRC_Guest 
    ADD CONSTRAINT fk_guest_country FOREIGN KEY ( country_id )
        REFERENCES "SSP_RES".SRC_Country ( country_id );

ALTER TABLE "SSP_RES".SRC_Apartment_Ocupancy 
    ADD CONSTRAINT fk_occupancy_apart FOREIGN KEY ( apartment_id )
        REFERENCES "SSP_RES".SRC_Apartment ( apartment_id );

ALTER TABLE "SSP_RES".SRC_Pricelist 
...
ALTER TABLE "SSP_RES".SRC_Reservation 
    ADD CONSTRAINT fk_res_guest FOREIGN KEY ( guest_id )
        REFERENCES "SSP_RES".SRC_Guest ( guest_id );
